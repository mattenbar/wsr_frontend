...
function DramatisPersonae(state, props) {
    if (state.categories.length > 0) {
        let posts = state.categories[11].attributes.posts.reverse();
                ...
                <>
                    ...
                    <div className="categoryTopTwo">
                        <div className="categoryTopLeft">
                            <Link
                                to={`/Dramatis-Personae/${newestPost.id}`}
                        ...
                        <div className="categoryTopRight">
                            <Link
                                to={`/Dramatis-Personae/${secondNewestPost.id}`}
            ...
            <>
                <div className="category-show">
                    ...
                    <div className="category-header">
                        <h1>DRAMATIS PERSONAE</h1>
                        <h4 className="tagline">
                            Spotlighting creative and contrarian firms and their
                            leaders
                        </h4>
                        <h5>
                            The most successful stories in wealth management
                            revolve around people and firms willing to stand out
                            with creative – and sometimes contrarian –
                            strategies.
                        </h5>
                    </div>
                </div>
