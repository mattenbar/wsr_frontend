                ...
                <>
                    ...
                    <div className="categoryTopTwo">
                        <div className="categoryTopLeft">
                            <Link
                                to={`/NewsMakers-Roundup/${newestPost.id}`}
                        ...
                        <div className="categoryTopRight">
                            <Link
                                to={`/NewsMakers-Roundup/${secondNewestPost.id}`}
            ...
            <>
                <div className="category-show">
                    ...
                    <div className="category-header">
                        <h1>NEWSMAKERS ROUNDUP</h1>
                        <h4 className="tagline">
                            Top news condensed from top wealth management media
                            outlets
                        </h4>
                        <h5>
                            Notes from Larry: I’ve assembled my personal picks
                            of top news stories from media outlets covering the
                            wealth management space – And why you should care.
                        </h5>
                    </div>
                </div>
                <div className="noPosts">
