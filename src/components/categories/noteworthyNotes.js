...
function NoteworthyNotes(state, props) {
    useEffect(() => {
      document.title = 'Noteworthy Notes | Wealth Solutions Report';
    });
                    ...
                    <div className="categoryTopTwo">
                        { newestPost !== undefined &&
                            <div className="categoryTopLeft">
                                <Link
                                    to={`/Noteworthy-Notes/${newestPost.id}`}
                        ...
                        { secondNewestPost !== undefined &&
                            <div className="categoryTopRight">
                                <Link
                                    to={`/Noteworthy-Notes/${secondNewestPost.id}`}
...
export default connect(mSTP)(NoteworthyNotes);
