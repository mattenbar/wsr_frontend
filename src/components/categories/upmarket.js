...
function Upmarket(state, props) {
    useEffect(() => {
      document.title = 'Upmarket | Wealth Solutions Report';
    });
                    ...
                    <div className="categoryTopTwo">
                        ...
                        { secondNewestPost !== undefined &&
                            <div className="categoryTopRight">
                                <Link
                                    to={`/Upmarket/${secondNewestPost.id}`}
...
export default connect(mSTP)(Upmarket);
