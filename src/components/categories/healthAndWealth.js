...
function HealthAndWealth(state, props) {
    useEffect(() => {
      document.title = 'Health & Wealth | Wealth Solutions Report';
    });
                    ...
                    <div className="categoryTopTwo">
                        { newestPost !== undefined &&
                            <div className="categoryTopLeft">
                                <Link
                                    to={`/Health-And-Wealth/${newestPost.id}`}
                        ...
                        { secondNewestPost !== undefined &&
                            <div className="categoryTopRight">
                                <Link
                                    to={`/Health-And-Wealth/${secondNewestPost.id}`}
...
export default connect(mSTP)(HealthAndWealth);
