...
function PointCounterPoint(props) {
    ...
    if (pointArticles.length > 0) {
        let newestSectionOne =
            pointArticles[pointArticles.length - 1].attributes;
        ...
        if (pointArticles.length > 1) {
            olderSectionTwo =
                pointArticles[pointArticles.length - 2].attributes;
            ...
            <div className="pointcpContainer">
                ...
                {inEditMode1 === true && (
                    <div className="individualPostDiv">
                        <PointcpEditForm
                            setInEditMode={setInEditMode1}
                            pointcpArticle={newestSectionOne}
                            pointcp_id={newestId}
                        />
                        <button
                ...
                {inEditMode2 === true && (
                    <div className="individualPostDiv">
                        <PointcpEditForm
                            setInEditMode={setInEditMode1}
                            pointcpArticle={olderSectionTwo}
                            pointcp_id={olderId}
                        />
                        <button
                            onClick={handleOnBack2}
                            className="adminButtons"
                        >
                            BACK TO POINT-CP
                        </button>
